...
%% Auteurs: Séverin Lemaignan, ...

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Mais non Nadia, il ne faut pas avoir peur ! %%
%%                                             %%
%% A savoir :                                  %%
%%  - les lignes qui commencent par % sont des %%
%%    commentaires.                            %%
%%  - ensuite, tu peux tout sauter jusqu'à     %% 
%%    l'endroit où j'ai écrit : LÀ!!           %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   \begin{pspicture}(0,0)
%      \rput(1,1){\psshadowbox*[fillcolor=green]{#1}}
%   \end{pspicture}
%\end{pdfpic}
\texttt{#1}
}
