...
\astuce{N'oubliez pas~! on peut toujours exécuter une action (ou un script) une
...
couleur détectée ...mais si vous affichez toujours la trace de votre bestiole,
vous devriez voir la trace repartir ! en effet, vu que notre objet est
...
\astuce{À vous de jouer~: Vous pouvez d'abord améilorer le calcul de l'échelle
...
\section{Bon appétit !} \fixme {Nourrir les bébêtes}
